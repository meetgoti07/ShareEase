...
import {editMyProperty, getMyPropertyById, getPropertyById} from "@/pages/rent/api/api.tsx";
...
export function EditProperty() {
    ...
    const form = useForm<PropertyFormValues>({
        ...
        defaultValues: async () => {
            if (id) {
                ...
                const data: PropertyFormValues = await getMyPropertyById(id);
    ...
    async function onSubmit(values: PropertyFormValues) {
        try {
                const data: PropertyFormValues = await editMyProperty(id || "" , values);
                if (data.id) {
                    toast({
